        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Verification', style: TextStyle(fontSize: 22.0),),
                ],
              ),
              SizedBox(height: 5.0,),
              Row(
                children: [
                  Flexible(child: Text("Enter verification code sent to your email")),
                ],
              ),
                ...
                child: Column(
                  children: [
                    TextFormField(
                      ...
                      obscureText: true,
                      validator: (val) => val!.isEmpty ? 'code cannot be empty' : null,
                      onChanged: (val) {
